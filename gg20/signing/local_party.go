...
func NewLocalPartyWithOneRoundSign(
	...
	return NewLocalParty(nil, params, key, out, end, fullBytesLen...)
}

func NewLocalPartyWithKDDAndOneRoundSign(
	params *tss.Parameters,
	key keygen.LocalPartySaveData,
	keyDerivationDelta *big.Int,
	out chan<- tss.Message,
	...
	return NewLocalPartyWithKDD(nil, params, key, keyDerivationDelta, out, end, fullBytesLen...)
}

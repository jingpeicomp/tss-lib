...
func NewDLogProof(ec elliptic.Curve, x *big.Int, X *crypto.ECPoint, rand io.Reader) (*DLogProof, error) {
...
func (pf *DLogProof) Verify(ec elliptic.Curve, X *crypto.ECPoint) bool {

...
func NewTProof(ec elliptic.Curve, TI, h *crypto.ECPoint, sigmaI, lI *big.Int, rand io.Reader) (*TProof, error) {
...
func (pf *TProof) Verify(ec elliptic.Curve, TI, h *crypto.ECPoint) bool {
...
func NewSTProof(ec elliptic.Curve, TI, R, h *crypto.ECPoint, sigmaI, lI *big.Int, rand io.Reader) (*STProof, error) {
...
func (pf *STProof) Verify(ec elliptic.Curve, SI, TI, R, h *crypto.ECPoint) bool {
	if pf == nil || !pf.ValidateBasic() {
		return false
	}
	ecParams := ec.Params()
